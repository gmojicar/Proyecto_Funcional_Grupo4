...
module nexys4ddr (
	...
	input  wire Forma0,
	input  wire Forma1,
	input  wire PromedioColor0,
	input  wire PromedioColor1
);
...
reg  csrbank0_Forma_re = 1'd0;
wire [1:0] csrbank0_Forma_r;
reg  csrbank0_Forma_we = 1'd0;
wire [1:0] csrbank0_Forma_w;
reg  csrbank0_PromedioColor_re = 1'd0;
wire [1:0] csrbank0_PromedioColor_r;
reg  csrbank0_PromedioColor_we = 1'd0;
wire [1:0] csrbank0_PromedioColor_w;
reg  csrbank0_MapaData0_re = 1'd0;
wire [3:0] csrbank0_MapaData0_r;
reg  csrbank0_MapaData0_we = 1'd0;
wire [3:0] csrbank0_MapaData0_w;
reg  csrbank0_MapaAddr0_re = 1'd0;
wire [5:0] csrbank0_MapaAddr0_r;
reg  csrbank0_MapaAddr0_we = 1'd0;
wire [5:0] csrbank0_MapaAddr0_w;
reg  csrbank0_MapaWrite0_re = 1'd0;
wire csrbank0_MapaWrite0_r;
reg  csrbank0_MapaWrite0_we = 1'd0;
wire csrbank0_MapaWrite0_w;
wire csrbank0_sel;
...
wire [2:0] csrbank1_in_r;
reg  csrbank1_in_we = 1'd0;
wire [2:0] csrbank1_in_w;
wire csrbank1_sel;
...
reg  csrbank3_w0_re = 1'd0;
wire [2:0] csrbank3_w0_r;
reg  csrbank3_w0_we = 1'd0;
wire [2:0] csrbank3_w0_w;
...
reg  csrbank4_infras2_re = 1'd0;
wire [4:0] csrbank4_infras2_r;
reg  csrbank4_infras2_we = 1'd0;
wire [4:0] csrbank4_infras2_w;
wire csrbank4_sel;
...
reg  csrbank6_move0_re = 1'd0;
wire [2:0] csrbank6_move0_r;
reg  csrbank6_move0_we = 1'd0;
wire [2:0] csrbank6_move0_w;
wire csrbank6_sel;
wire [13:0] interface7_bank_bus_adr;
wire interface7_bank_bus_we;
wire [31:0] interface7_bank_bus_dat_w;
reg  [31:0] interface7_bank_bus_dat_r = 32'd0;
reg  csrbank7_ctr0_re = 1'd0;
wire [1:0] csrbank7_ctr0_r;
reg  csrbank7_ctr0_we = 1'd0;
wire [1:0] csrbank7_ctr0_w;
wire csrbank7_sel;
...
assign csrbank0_Forma_w = Forma_status[1:0];
assign Forma_we = csrbank0_Forma_we;
assign csrbank0_PromedioColor_w = PromedioColor_status[1:0];
assign PromedioColor_we = csrbank0_PromedioColor_we;
assign csrbank0_MapaData0_w = MapaData_storage[3:0];
assign csrbank0_MapaAddr0_w = MapaAddr_storage[5:0];
assign csrbank0_MapaWrite0_w = MapaWrite_storage;
...
assign csrbank1_in_w = buttons_status[2:0];
assign buttons_we = csrbank1_in_we;
...
assign csrbank3_w0_w = _w_storage[2:0];
assign _r_status = sda1;
assign csrbank3_r_w = _r_status;
assign _r_we = csrbank3_r_we;
...
assign csrbank4_infras2_w = infrarrojo_status[4:0];
assign infrarrojo_we = csrbank4_infras2_we;
...
assign csrbank6_move0_w = ruedas_storage[2:0];
...
assign csrbank7_ctr0_w = servo_radar_storage[1:0];
...
assign csrbank10_dist_w = dist_status[8:0];
assign dist_we = csrbank10_dist_we;
...
always @(posedge sys_clk) begin
	...
	if (csrbank0_sel) begin
		case (interface0_bank_bus_adr[8:0])
			1'd0: begin
				interface0_bank_bus_dat_r <= csrbank0_Forma_w;
			end
			1'd1: begin
				interface0_bank_bus_dat_r <= csrbank0_PromedioColor_w;
			end
			2'd2: begin
				interface0_bank_bus_dat_r <= csrbank0_MapaData0_w;
			end
			2'd3: begin
				interface0_bank_bus_dat_r <= csrbank0_MapaAddr0_w;
			end
			3'd4: begin
				interface0_bank_bus_dat_r <= csrbank0_MapaWrite0_w;
			end
		endcase
	end
	Forma_re <= csrbank0_Forma_re;
	PromedioColor_re <= csrbank0_PromedioColor_re;
	if (csrbank0_MapaData0_re) begin
		MapaData_storage[3:0] <= csrbank0_MapaData0_r;
	end
	MapaData_re <= csrbank0_MapaData0_re;
	if (csrbank0_MapaAddr0_re) begin
		MapaAddr_storage[5:0] <= csrbank0_MapaAddr0_r;
	end
	MapaAddr_re <= csrbank0_MapaAddr0_re;
	if (csrbank0_MapaWrite0_re) begin
		MapaWrite_storage <= csrbank0_MapaWrite0_r;
	end
	MapaWrite_re <= csrbank0_MapaWrite0_re;
	...
	if (csrbank3_sel) begin
		case (interface3_bank_bus_adr[8:0])
			1'd0: begin
				interface3_bank_bus_dat_r <= csrbank3_w0_w;
			end
			1'd1: begin
	...
	if (csrbank3_w0_re) begin
		_w_storage[2:0] <= csrbank3_w0_r;
	end
	_w_re <= csrbank3_w0_re;
	_r_re <= csrbank3_r_re;
	interface4_bank_bus_dat_r <= 1'd0;
	if (csrbank4_sel) begin
		case (interface4_bank_bus_adr[8:0])
			1'd0: begin
				interface4_bank_bus_dat_r <= csrbank4_infras2_w;
			end
		endcase
	end
	infrarrojo_re <= csrbank4_infras2_re;
	...
	if (csrbank6_sel) begin
		case (interface6_bank_bus_adr[8:0])
			1'd0: begin
				interface6_bank_bus_dat_r <= csrbank6_move0_w;
			end
		endcase
	end
	if (csrbank6_move0_re) begin
		ruedas_storage[2:0] <= csrbank6_move0_r;
	end
	ruedas_re <= csrbank6_move0_re;
	interface7_bank_bus_dat_r <= 1'd0;
	if (csrbank7_sel) begin
		case (interface7_bank_bus_adr[8:0])
			1'd0: begin
				interface7_bank_bus_dat_r <= csrbank7_ctr0_w;
			end
		endcase
	end
	if (csrbank7_ctr0_re) begin
		servo_radar_storage[1:0] <= csrbank7_ctr0_r;
	end
	servo_radar_re <= csrbank7_ctr0_re;
...
//------------------------------------------------------------------------------
// Memory mem: 5433-words x 32-bit
//------------------------------------------------------------------------------
...
servo_radar servo_radar(
	.clk(sys_clk),
	.ctr(servo_radar_storage),
	.servo(servo)
);
...
infrarrojo infrarrojo(
	.infras({infras4, infras3, infras2, infras1, infras0}),
	.infras2(infrarrojo_status)
);
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-02-10 14:11:40.
//------------------------------------------------------------------------------
